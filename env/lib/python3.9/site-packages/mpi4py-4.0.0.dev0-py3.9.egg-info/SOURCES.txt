...
conf/requirements-build-mesonpy.txt
conf/requirements-build-skbuild.txt
conf/requirements-docs.txt
conf/requirements-lint.txt
conf/requirements-test.txt
conf/requirements-type.txt
conf/mpiuni/mpi.h
conf/nompi/mpi.h
conf/nompi/pympiconf.h
demo/README.txt
demo/helloworld.c
demo/helloworld.cxx
demo/helloworld.f08
...
demo/osu_scatter.py
demo/python-config
demo/check-mpiexec/makefile
demo/check-mpiexec/run.sh
...
demo/futures/run_cpi.py
demo/futures/run_crawl.py
demo/futures/run_hello.py
...
demo/profiling/cpi.py
demo/profiling/makefile
demo/profiling/ring.py
demo/profiling/threads.py
...
demo/wrap-ctypes-f08/helloworld.f08
demo/wrap-ctypes-f08/helloworld.py
demo/wrap-ctypes-f08/makefile
demo/wrap-ctypes-f08/test.py
demo/wrap-ctypes-f90/helloworld.f90
demo/wrap-ctypes-f90/helloworld.py
demo/wrap-ctypes-f90/makefile
demo/wrap-ctypes-f90/test.py
...
docs/source/mpi4py.MPI.rst
docs/source/mpi4py.bench.rst
docs/source/mpi4py.futures.rst
docs/source/mpi4py.rst
docs/source/mpi4py.run.rst
docs/source/mpi4py.typing.rst
docs/source/mpi4py.util.dtlib.rst
docs/source/mpi4py.util.pkl5.rst
docs/source/mpi4py.util.pool.rst
docs/source/mpi4py.util.rst
...
src/lib-mpi/dynload.h
src/lib-mpi/fallback.h
src/lib-mpi/largecnt.h
src/lib-mpi/missing.h
src/lib-mpi/mpiulfm.h
...
src/mpi4py/util/pool.py
src/mpi4py/util/pool.pyi
test/arrayimpl.py
test/coverage.sh
test/dlpackimpl.py
test/main.py
